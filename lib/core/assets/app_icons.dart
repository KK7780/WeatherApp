...
class AppIcons {
  // Словник: ключ стану погоди → шлях до PNG
  static const Map<String, String> weatherIcons = {
    "Ясно": "lib/core/assets/icons/sunny_sun_weather_climate_forecast.png",
    "хмарно": "lib/core/assets/icons/cloudy.png",
    "дощ": "lib/core/assets/icons/rain.png",
    "сніг": "lib/core/assets/icons/snow.png",
    "шторм": "lib/core/assets/icons/storm.png",
  };

  // Метод для отримання віджета Image за ключем
